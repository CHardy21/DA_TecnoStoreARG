...
# --- Crear columna fecha sintética ---
# Usamos año + nombre_mes + día fijo (1)
...
mapping = {
    ...
    "Chaco": "Chaco",
    "Chubut": "Chubut",
    "Córdoba": "Cordoba",          # sin tilde en el GeoJSON
    "Corrientes": "Corrientes",
    "Entre Ríos": "Entre Rios",    # sin tilde
    "Formosa": "Formosa",
    "Jujuy": "Jujuy",
    "La Pampa": "La Pampa",
    "La Rioja": "La Rioja",
    "Mendoza": "Mendoza",
    "Misiones": "Misiones",
    "Neuquén": "Neuquen",          # sin tilde
    "Río Negro": "Rio Negro",      # sin tilde
    "Salta": "Salta",
    "San Juan": "San Juan",
    "San Luis": "San Luis",
...
st.markdown("---")
st.write("📌 *Dashboard basado en el modelo estrella consolidado con columna `fecha` sintética.*")
